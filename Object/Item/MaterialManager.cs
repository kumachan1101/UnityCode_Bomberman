...
public class MaterialManager : MonoBehaviour
{
    ...
    public string GetBomMaterialByPlayerName(string playerName)
    {
        ...
        string suffix = playerName.Replace("Player", "").Replace("Dummy", "").Replace("Online", "").Replace("(Clone)", "").Replace("(Instance)", "").Replace("BomMaterial", "").Replace("(Material)", "").Replace("Tower", "");
